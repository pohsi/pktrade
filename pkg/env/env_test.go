...
func (m *myBool) Set(v string) error {
	r, err := strconv.ParseBool(strings.ToUpper(v))
	if err != nil {
		return err
	}
	*m = myBool(r)
...
func (m *myInt) UnmarshalText(data []byte) error {
...
func (m *myString) UnmarshalBinary(data []byte) error {
	*m = myString(string(data) + "ok")
	return nil
}
...
func Test_setValue(t *testing.T) {
	...
	tests := []struct {
		...
		{"t7.1", reflect.ValueOf(&cfg.mybool), "1", myBool(true), true, false},
		{"t7.2", reflect.ValueOf(&cfg.mybool), "TRuE", myBool(true), true, false},
		{"t7.3", reflect.ValueOf(&cfg.mybool), "TRUE", myBool(true), true, false},
